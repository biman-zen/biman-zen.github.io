...
![Distribution Plot]({{"/assets/post_figures/11-10-analysis/dataset_figure.jpg.png" | relative_url }}){:style="width: 75%; height: auto;"}
...
![Distribution Plot]({{"/assets/post_figures/11-10-analysis/KDE_revenue_distribution.png" | relative_url }}){:style="width: 75%; height: auto;"}  
...
![Pie Chart]({{"/assets/post_figures/11-10-analysis/SalesMethod_Proportion_PieChart.png" | relative_url }}){:style="width: 75%; height: auto;"}  
...
![Revenue Chart]({{"/assets/post_figures/11-10-analysis/Revenue_bysales.png" | relative_url }}){:style="width: 75%; height: auto;"}

The total sales across the time frame seems to be steady with a low dip in the final week.
![Revenue Chart]({{"/assets/post_figures/11-10-analysis/Total_Revenue_acrossWeeks.png" | relative_url }}){:style="width: 75%; height: auto;"}

[<img src="{{ 'Total_Revenue_acrossWeeks.png' | relative_url }}" 
     alt="Revenue Chart" 
